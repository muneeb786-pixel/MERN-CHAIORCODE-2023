  ...
  return (
    <div className='flex  items-center justify-center w-full'>
        <div className='mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border-black/10'>
            ...
            <h2 className='mt-2 text-center text-base text-black/60'>Sign in to your accound</h2>
            ...
            <form onSubmit={handleSubmit(handleLogin)} className='mt-8'>
                <div className='space-y-5'>
                    ...
                    />
                    <Button type="submit" className='w-full' bgColor='bg-blue-400'>Sign in</Button>
                </div>
            </form>
        </div>
    </div>
